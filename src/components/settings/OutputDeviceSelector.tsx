/**
 * Output Device Selector Component for Voyc
 * Dropdown for selecting audio output device for feedback sounds
 * Adapted from Handy's OutputDeviceSelector
 */
...
import type { AudioDevice } from "../../stores/settingsStore";
  ...
  React.memo(
    ({ descriptionMode = "tooltip", grouped = false, disabled = false }) => {
      ...
      return (
        <SettingContainer
          title="Output Device"
          description="Select the speaker for audio feedback sounds"
...
OutputDeviceSelector.displayName = "OutputDeviceSelector";
