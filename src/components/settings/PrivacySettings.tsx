        ...
        <div className="prose prose-sm prose-invert max-w-none">
          <div className="p-4 rounded-lg bg-logo-primary/5 border border-logo-primary/20 mb-4">
            ...
            <p className="text-xs text-text/70">
              Voyc is designed with privacy as a core principle. Your voice data is processed
              locally whenever possible, and cloud services are only used when explicitly enabled.
            </p>
          </div>

          <div className="space-y-4 text-sm text-text/80">
            <div>
              <h4 className="font-medium text-text mb-1">Local Processing (Default)</h4>
              <p className="text-text/60">
                When using local Whisper models, all audio processing happens entirely on your device.
            ...
            <div>
              ...
              <p className="text-text/60">
                If cloud fallback is enabled and local confidence is below threshold, audio may be
                sent to your configured cloud provider (ElevenLabs or OpenAI) for processing.
            ...
            <div>
              ...
              <p className="text-text/60">
                By default, Voyc does not store raw audio recordings. Audio is processed in real-time
                and discarded after transcription. This cannot be changed in the current version.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-text/60">
                Your settings (API keys, preferences) are stored locally on your device in encrypted
                format. They are never transmitted to external servers.
              </p>
            </div>
          </div>
        </div>
      ...
      <SettingsGroup title="Log Redaction (REQ-020)">
        <div className="space-y-4">
          <p className="text-sm text-text/60">
            Application logs are automatically redacted to remove sensitive information.
            Raw audio and full transcription text are never written to log files.
          </p>
          ...
          <div className="p-3 rounded-lg bg-mid-gray/10">
            ...
            <p className="text-xs text-text/50">
              Sensitive data is automatically masked in logs: API keys, transcription content,
              and audio metadata are replaced with [REDACTED] markers.
            </p>
          </div>
        </div>
      </SettingsGroup>
